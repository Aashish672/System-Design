...
// NewLine represents a line break in the document.
...
// TabSpaceElement represents a tab sequence in the document
...
class FileStorage implements Persistence {
    ...
    public void save(String data) {
        try {
            ...
            outFile.write(data);
            outFile.close();
            System.out.println("Document saved to document1.txt");
        } catch (IOException e) {
